...
public class SortingShenanigans {
    ...
    public class Analyser {
        ...
        Analyser(long[] trials, int trialOneSize, int trialTwoSize, int trialThreeSize) {
            this.trialsTime = trials.clone();
            findRelative(this.trialsTime);

            trialTwo = trialTwoSize / trialOneSize;
            trialThree = trialThreeSize / trialOneSize;

            for (long current : this.trialsTime) {
                total += current;
            }
        ...
        public String test() {
            ...
            double[] results = new double[] {
                difference(linear, trialsTime),
                difference(constant, trialsTime),
                difference(log, trialsTime),
                difference(nlog, trialsTime),
                difference(squared, trialsTime),
                difference(factorial, trialsTime)
            };
